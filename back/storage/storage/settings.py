...
SECRET_KEY = 'django-insecure-4lx7egxmn7=pibx^qci%i@5#v8jr9icdyl#eo)+)gz^fy!xg2+'
...
DATABASES = {
     'default': {
        ...
        'NAME': 'test2',  # Имя вашей БД в pgAdmin
...
CORS_ALLOW_ALL_ORIGINS = True  # Для разработки, в production укажите конкретные origins
